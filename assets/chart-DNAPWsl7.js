import{Q as Ae,S as xe,T as $e,V as Ve,W as Ie,s as ne,j as Te,B as T,G as Me,H as Oe,p as Fe,Z as G,I as Ke,b as je,R as Re,X as He,U as de,M as ze,N as Ye,P as ue}from"./ingredients-BGCP0jRb.js";import{B as U,c as b,o as p,e as c,b as k,m as h,_ as Ue,f as ee,j as Ne,a as K,w as P,h as w,T as pe,q as fe,r as L,F,n as ge,t as B,d as me,R as We,x as Xe,y,E as Ze,D as qe,G as C,g as Q,S as Ge,k as Qe}from"./index-DUfizBA1.js";import{d as J}from"./dayjs.min-Cbbdfn5l.js";import{t as _}from"./tempData-DSlHWuUw.js";import{s as Je,F as _e}from"./index-DiCpnNHQ.js";var et=function(t){var n=t.dt;return`
.p-slider {
    position: relative;
...
`)},Vt={root:function(t){var n=t.props;return["p-panel p-component",{"p-panel-toggleable":n.toggleable}]},header:"p-panel-header",title:"p-panel-title",headerActions:"p-panel-header-actions",pcToggleButton:"p-panel-toggle-button",contentContainer:"p-panel-content-container",content:"p-panel-content",footer:"p-panel-footer"},It=U.extend({name:"panel",theme:$t,classes:Vt}),Tt={name:"BasePanel",extends:ne,props:{header:String,toggleable:Boolean,collapsed:Boolean,toggleButtonProps:{type:Object,default:function(){return{severity:"secondary",text:!0,rounded:!0}}}},style:It,provide:function(){return{$pcPanel:this,$parentInstance:this}}},ke={name:"Panel",extends:Tt,inheritAttrs:!1,emits:["update:collapsed","toggle"],data:function(){return{id:this.$attrs.id,d_collapsed:this.collapsed}},watch:{"$attrs.id":function(t){this.id=t||de()},collapsed:function(t){this.d_collapsed=t}},mounted:function(){this.id=this.id||de()},methods:{toggle:function(t){this.d_collapsed=!this.d_collapsed,this.$emit("update:collapsed",this.d_collapsed),this.$emit("toggle",{originalEvent:t,value:this.d_collapsed})},onKeyDown:function(t){(t.code==="Enter"||t.code==="NumpadEnter"||t.code==="Space")&&(this.toggle(t),t.preventDefault())}},computed:{buttonAriaLabel:function(){return this.toggleButtonProps&&this.toggleButtonProps.ariaLabel?this.toggleButtonProps.ariaLabel:this.header}},components:{PlusIcon:we,MinusIcon:He,Button:T},directives:{ripple:Re}},Mt=["id"],Ot=["id","aria-labelledby"];function Ft(e,t,n,a,o,r){var l=ee("Button");return p(),b("div",h({class:e.cx("root")},e.ptmi("root")),[c("div",h({class:e.cx("header")},e.ptm("header")),[L(e.$slots,"header",{id:o.id+"_header",class:ge(e.cx("title"))},function(){return[e.header?(p(),b("span",h({key:0,id:o.id+"_header",class:e.cx("title")},e.ptm("title")),B(e.header),17,Mt)):k("",!0)]}),c("div",h({class:e.cx("headerActions")},e.ptm("headerActions")),[L(e.$slots,"icons"),e.toggleable?(p(),K(l,h({key:0,id:o.id+"_header",class:e.cx("pcToggleButton"),"aria-label":r.buttonAriaLabel,"aria-controls":o.id+"_content","aria-expanded":!o.d_collapsed,unstyled:e.unstyled,onClick:r.toggle,onKeydown:r.onKeyDown},e.toggleButtonProps,{pt:e.ptm("pcToggleButton")}),{icon:P(function(E){return[L(e.$slots,e.$slots.toggleicon?"toggleicon":"togglericon",{collapsed:o.d_collapsed},function(){return[(p(),K(me(o.d_collapsed?"PlusIcon":"MinusIcon"),h({class:E.class},e.ptm("pcToggleButton").icon),null,16,["class"]))]})]}),_:3},16,["id","class","aria-label","aria-controls","aria-expanded","unstyled","onClick","onKeydown","pt"])):k("",!0)],16)],16),w(pe,h({name:"p-toggleable-content"},e.ptm("transition")),{default:P(function(){return[fe(c("div",h({id:o.id+"_content",class:e.cx("contentContainer"),role:"region","aria-labelledby":o.id+"_header"},e.ptm("contentContainer")),[c("div",h({class:e.cx("content")},e.ptm("content")),[L(e.$slots,"default")],16),e.$slots.footer?(p(),b("div",h({key:0,class:e.cx("footer")},e.ptm("footer")),[L(e.$slots,"footer")],16)):k("",!0)],16,Ot),[[We,!o.d_collapsed]])]}),_:3},16)],16)}ke.render=Ft;const Kt={class:"card"},jt={class:"fixed top-4 right-4"},Rt={class:"flex justify-between text-sm text-gray-600"},Ht={class:"card"},zt={class:"flex items-center py-2 border-b border-[var(--line-color)]"},Yt={class:"flex py-1"},Ut=["for"],Nt={class:"grid grid-cols-2 gap-1"},Wt={key:0,class:"text-gray-500"},Xt={class:"flex w-full justify-center"},_t=Xe({__name:"chart",setup(e){function t(i){const d=new Map;return i.forEach(s=>{for(const f of Object.keys(s.options))s.options[f].forEach(g=>{const u=ze[f].find(m=>m.value===g);if(u){const m=`${u.label}-${f}-${g}`;d.has(m)?(d.get(m).counts++,s.id&&d.get(m).ids.push(s.id)):d.set(m,{options:u.label,optionsValue:[f,g],counts:1,ids:s.id?[s.id]:[]})}})}),Array.from(d.values())}const n=y(t(_.value)),a=y(),o=y(),r=y(n.value.map(i=>i.optionsValue));Ze(r,i=>{R.value=i.length===n.value.length},{deep:!0});const l=(i=n.value)=>{const d=[...new Set(i.map(u=>u.options))],s=[],f=[];for(let u=0;u<100;u++){const m=u*3.6;s.push(`hsl(${m}, 70%, 50%, 0.2)`),f.push(`hsl(${m}, 70%, 50%)`)}const g=d.map(u=>i.filter(m=>m.options===u).reduce((m,x)=>m+x.counts,0));return{labels:d,datasets:[{label:"Options",data:g,backgroundColor:d.map((u,m)=>s[m%s.length]),borderColor:d.map((u,m)=>f[m%f.length]),borderWidth:1}]}},E=()=>{const i=getComputedStyle(document.documentElement),d=i.getPropertyValue("--p-text-muted-color"),s=i.getPropertyValue("--p-content-border-color");return{indexAxis:"y",maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{x:{ticks:{color:d},grid:{color:s}},y:{beginAtZero:!0,ticks:{color:d},grid:{color:s}}}}},A=y(!1),N=y(!0),R=y(!0),M=y(n.value),D=y([0,24]),Ce=y(new Date("2025-02-22")),De=y(new Date("2025-04-07")),O=y([Ce.value,De.value]),Se=()=>{R.value?r.value=n.value.map(i=>i.optionsValue):r.value=[]},re=["bg-blue-200","bg-green-200","bg-yellow-200","bg-red-200","bg-purple-200","bg-pink-200","bg-teal-200","bg-indigo-200","bg-gray-200","bg-blue-400","bg-green-400","bg-yellow-400","bg-red-400","bg-purple-400","bg-pink-400","bg-teal-400","bg-indigo-400","bg-gray-400","bg-blue-600","bg-green-600","bg-yellow-600","bg-red-600","bg-purple-600","bg-pink-600","bg-teal-600","bg-indigo-600","bg-gray-600","bg-blue-800","bg-green-800","bg-yellow-800"],Le={"bg-blue-200":"#93C5FD","bg-green-200":"#86EFAC","bg-yellow-200":"#FDE68A","bg-red-200":"#FCA5A5","bg-purple-200":"#D8B4FE","bg-pink-200":"#F9A8D4","bg-teal-200":"#99F6E4","bg-indigo-200":"#BFDBFE","bg-gray-200":"#E5E7EB","bg-blue-400":"#60A5FA","bg-green-400":"#4ADE80","bg-yellow-400":"#FACC15","bg-red-400":"#F87171","bg-purple-400":"#BE77F1","bg-pink-400":"#F472B6","bg-teal-400":"#4FD1C5","bg-indigo-400":"#818CF8","bg-gray-400":"#9CA3AF","bg-blue-600":"#2563EB","bg-green-600":"#10B981","bg-yellow-600":"#D97706","bg-red-600":"#DC2626","bg-purple-600":"#7C3AED","bg-pink-600":"#DB2777","bg-teal-600":"#0D9488","bg-indigo-600":"#4F46E5","bg-gray-600":"#4B5563","bg-blue-800":"#1E40AF","bg-green-800":"#065F46","bg-yellow-800":"#92400E"};let W=0;const ae=()=>{const i=re[W];return W=(W+1)%re.length,i},H=y(!1),S=y(null),Be=()=>{H.value=!H.value,Z()},X=i=>`${String(Math.floor(i)).padStart(2,"0")}:${String(Math.floor(i%1*60)).padStart(2,"0")}`,Z=()=>{if(!S.value)return;S.value.width=window.innerWidth-40,S.value.height=window.innerHeight-140;const i=S.value.getContext("2d");if(!i)return;i.clearRect(0,0,S.value.width,S.value.height);const s=[...new Set(z.value.flatMap(v=>v.data.map($=>$.options)))].map(String),f=Math.max(...s.map(v=>v.length))*18;S.value.height=window.innerHeight-140+f;const g=S.value.height-50-f,u=70,m=S.value.width-50;i.beginPath(),i.moveTo(u,g),i.lineTo(m,g),i.moveTo(u,50),i.lineTo(u,g),i.strokeStyle="#ddd",i.stroke(),s.forEach((v,$)=>{const I=u-10,V=g-($+1)*(g-50)/(s.length+1);i.font="14px Arial",i.textAlign="right",i.textBaseline="middle",i.fillStyle="#333",i.fillText(v,I,V)});const x=D.value[1]-D.value[0];for(let v=0;v<=x;v++){const $=D.value[0]+v,I=X($),V=u+v/x*(m-u);i.beginPath(),i.moveTo(V,g),i.lineTo(V,50),i.strokeStyle="#f0f0f0",i.stroke(),i.font="12px Arial",i.textAlign="center",i.textBaseline="top",i.fillStyle="#333",i.fillText(I,V,g+8)}z.value.forEach(v=>{const $=Le[v.useColor];v.data.forEach(I=>{const V=String(I.options),oe=s.indexOf(V);if(oe===-1)return;const Y=new Date(I.timestampCurrentDateTime),q=Y.getHours()+Y.getMinutes()/60+Y.getSeconds()/3600;if(q>=D.value[0]&&q<=D.value[1]){const se=u+(q-D.value[0])/x*(m-u),le=g-(oe+1)*(g-50)/(s.length+1);if(i.fillStyle=$,i.beginPath(),i.arc(se,le,5,0,2*Math.PI),i.fill(),H.value){i.font="12px Arial",i.textAlign="left",i.textBaseline="bottom",i.fillStyle="black";const Pe=Y.toLocaleTimeString("en-GB",{hour:"2-digit",minute:"2-digit",second:"2-digit"});i.fillText(Pe,se+10,le+7)}}})})},ie=i=>{const d={};return i.forEach(s=>{s.ids.forEach(f=>{const g=_.value.find(u=>u.id===f);if(g){const u=g.isCurrentDate,m=g.isCurrentTime,x=g.timestampCurrentDateTime,v=ae();d[u]||(d[u]=[]),d[u].push({time:m,options:s.options,optionsValue:s.optionsValue,useColor:v,timestampCurrentDateTime:x,remark:g.remark})}})}),Object.keys(d).map(s=>({date:s,useColor:ae(),data:d[s]}))},z=y(ie(M.value)),Ee=()=>{let i=_.value;if(O.value.length===2){const s=J(O.value[0]).format("YYYY-MM-DD"),f=J(O.value[1]).format("YYYY-MM-DD");i=i.filter(g=>{const u=J(g.isCurrentDate).format("YYYY-MM-DD");return u>=s&&u<=f})}const d=t(i);r.value.length>0?M.value=d.filter(s=>r.value.some(f=>f[0]===s.optionsValue[0]&&f[1]===s.optionsValue[1])):M.value=d,z.value=ie(M.value),Z(),a.value=l(M.value),A.value=!1};return qe(()=>{a.value=l(),o.value=E(),Z()}),(i,d)=>(p(),b(F,null,[c("div",Kt,[w(C(ve),{type:"bar",data:a.value,options:o.value,class:"h-screen"},null,8,["data","options"])]),c("div",jt,[w(C(ye),{visible:A.value,"onUpdate:visible":d[6]||(d[6]=s=>A.value=s),header:"Filter",position:"right",class:"!w-1/4"},{footer:P(()=>[c("div",Nt,[w(C(T),{label:"Cancel",onClick:d[4]||(d[4]=s=>A.value=!1)}),w(C(T),{label:"Filter",onClick:d[5]||(d[5]=s=>Ee())})])]),default:P(()=>[c("div",null,[w(C(Ye),{modelValue:O.value,"onUpdate:modelValue":d[0]||(d[0]=s=>O.value=s),selectionMode:"range",placeholder:"選擇日期範圍",class:"p-inputtext w-full",showButtonBar:""},null,8,["modelValue"]),w(C(be),{modelValue:D.value,"onUpdate:modelValue":d[1]||(d[1]=s=>D.value=s),range:"",class:"my-4 w-full",min:0,max:24,step:1},null,8,["modelValue"]),c("div",Rt,[c("span",null,B(X(D.value[0])),1),c("span",null,B(X(D.value[1])),1)])]),c("div",Ht,[c("div",zt,[w(C(ue),{inputId:"select-all",modelValue:R.value,"onUpdate:modelValue":d[2]||(d[2]=s=>R.value=s),onChange:Se,class:"mr-1",binary:!0},null,8,["modelValue"]),d[8]||(d[8]=c("label",{for:"select-all",class:"w-full inline-block font-bold"}," 全選/取消全選 ",-1))]),(p(!0),b(F,null,Q(n.value,s=>(p(),b("div",{key:s.options},[c("ul",null,[c("li",Yt,[w(C(ue),{inputId:s.options,value:s.optionsValue,modelValue:r.value,"onUpdate:modelValue":d[3]||(d[3]=f=>r.value=f),class:"mr-1"},null,8,["inputId","value","modelValue"]),c("label",{for:s.options,class:"w-full inline-block"},B(s.options),9,Ut)])])]))),128))])]),_:1},8,["visible"]),w(C(T),{class:"!bg-[var(--main-color)]",icon:"pi pi-filter",onClick:d[7]||(d[7]=s=>A.value=!0)}),w(C(T),{onClick:Be,label:H.value?"隱藏時間":"顯示時間",class:"p-button-secondary ml-2"},null,8,["label"])]),c("main",null,[w(C(ke),{header:"Detail Information",toggleable:"",collapsed:N.value,class:"p-2 m-2 [&>div]:mb-1 text-sm"},{default:P(()=>[(p(!0),b(F,null,Q(z.value,s=>(p(),b("div",{key:s.date,class:"mb-4"},[c("div",{class:"font-bold",style:Ge({color:s.useColor})},B(s.date),5),c("div",null,[(p(!0),b(F,null,Q(s.data,(f,g)=>(p(),b("div",{key:g},[Qe(B(f.time)+" - "+B(f.options)+" ",1),f.remark?(p(),b("span",Wt,"("+B(f.remark)+")",1)):k("",!0)]))),128))])]))),128))]),_:1},8,["collapsed"]),c("div",Xt,[c("canvas",{ref_key:"canvas",ref:S},null,512)])])],64))}});export{_t as default};
