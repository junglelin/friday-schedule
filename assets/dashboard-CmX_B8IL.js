import{l as Ze,s as at,a as xn,b as ci,c as ui,d as di,e as pi,_ as Jt}from"./chart.vue_vue_type_script_setup_true_lang-CkDlQeI4.js";import{d as te,s as ne,a as ye,b as An,c as Ut,e as Bn,f as Dn,i as it,g as ze,h as Pe,j as fi,k as hi,l as mi,m as gi,R as Mt,n as Ue,o as Yt,p as bi,q as yi,r as ve,t as vi,C as wi,u as Si,v as Oi,w as Ii,Z as gt,x as ki,O as Ci,y as Ti,z as Ei,A as Ri,B as Li,D as Fe,U as Xt,E as Fi,F as Zt,G as xi,H as Qt,I as en,J as Ai}from"./ingredients-DYo5kVXa.js";import{d as lt,r as _,u as zn,o as _t,c as Pn,a as O,b,e as pe,t as x,f as $,g as M,h as U,i as P,j as m,B as be,k as B,m as v,l as re,n as Y,F as K,p as oe,q as Bi,s as Un,v as ee,w as j,T as Mn,x as _n,y as Qe,z as It,C as Ge,A as Di,D as tn,E as kt,G as zi,H as ct,_ as Pi,I as Ui,J as Mi,K as _i,L as Ni,M as Vi,N as $i,O as nn,S as ji,P as Hi,Q as Ki,R as Ct,U as et,V as xe,W as Tt,X as Et,Y as Nn,Z as qi,$ as sn,a0 as on,a1 as Wi}from"./index-Dzkn8ZTM.js";const Gi="/friday-schedule/192x192.png",Ji={class:"p-2 sticky top-0 z-20 bg-[var(--bg-color)]"},Yi={class:"grid grid-cols-[3fr_1fr]"},Xi={class:"!text-lg font-extrabold flex items-center"},Zi={class:"w-full text-xs text-gray-400"},Qi={class:"text-right"},eo=lt({__name:"AppHeader",props:{isListView:{type:Boolean},savedDateTime:{}},emits:["toggleView","refresh"],setup(e,{emit:t}){const n=e,s=t,o=_(null),i=zn(),r=()=>{s("toggleView")},a=()=>{i.require({message:"雲端資料將會同步至LocalForage中，減少雲端讀取流量",header:"確認同步雲端資料？",icon:"pi pi-exclamation-triangle",rejectProps:{label:"取消",severity:"secondary",outlined:!0},acceptProps:{label:"確認",severity:"danger"},accept:()=>{s("refresh")},reject:()=>{}})};async function u(){o.value=await Ze.getItem("friday-schedule-filedata-savedatetime")}_t(async()=>{u()});const l=Pn(()=>n.savedDateTime||o.value);return(c,p)=>(m(),O("header",Ji,[b("div",Yi,[b("h1",Xi,[p[1]||(p[1]=b("img",{src:Gi,class:"w-[50px] mr-2"},null,-1)),b("div",null,[p[0]||(p[0]=pe(" Friday Daily Schedule ")),b("div",Zi," 最新資料時間: "+x(l.value?$(te)(l.value).format("YYYY-MM-DD HH:mm:ss"):"N/A"),1)])]),b("div",Qi,[n.isListView?(m(),M($(ne),{key:0,class:"!bg-[var(--main-color)] mr-2",icon:"pi pi-sync",onClick:a})):U("",!0),P($(ne),{class:"!bg-[var(--main-color)]",icon:n.isListView?"pi pi-chart-bar":"pi pi-list",onClick:r,disabled:n.isListView&&!l.value},null,8,["icon","disabled"])])])]))}});var to=function(t){var n=t.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
...
`)},go={root:"p-iconfield"},bo=be.extend({name:"iconfield",theme:mo,classes:go}),yo={name:"BaseIconField",extends:ye,style:bo,provide:function(){return{$pcIconField:this,$parentInstance:this}}},Kn={name:"IconField",extends:yo,inheritAttrs:!1};function vo(e,t,n,s,o,i){return m(),O("div",v({class:e.cx("root")},e.ptmi("root")),[B(e.$slots,"default")],16)}Kn.render=vo;var wo={root:"p-inputicon"},So=be.extend({name:"inputicon",classes:wo}),Oo={name:"BaseInputIcon",extends:ye,style:So,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},qn={name:"InputIcon",extends:Oo,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function Io(e,t,n,s,o,i){return m(),O("span",v({class:i.containerClass},e.ptmi("root")),[B(e.$slots,"default")],16)}qn.render=Io;var ko=function(t){var n=t.dt;return`
