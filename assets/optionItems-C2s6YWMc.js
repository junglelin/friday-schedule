import{B as H,a4 as J,c as h,o as p,e as d,m as C,r as M,H as q,L as Q,M as W,N as S,aF as X,aG as E,I as V,y as r,S as c,b as Y,az as Z,D as f,A as ee,t as B,aB as te,aH as L,aI as N,x as ne,F as I,u as z,aJ as ae,aE as oe,aK as le,aL as ie}from"./index-ByowsrrQ.js";import{s as se}from"./index-CqvIweJK.js";import{d as ce}from"./vuedraggable.umd-hsksGgqg.js";var re=function(o){var e=o.dt;return`
.p-toggleswitch {
...
`)},de={root:{position:"relative"}},ue={root:function(o){var e=o.instance,w=o.props;return["p-toggleswitch p-component",{"p-toggleswitch-checked":e.checked,"p-disabled":w.disabled,"p-invalid":e.$invalid}]},input:"p-toggleswitch-input",slider:"p-toggleswitch-slider",handle:"p-toggleswitch-handle"},ge=H.extend({name:"toggleswitch",theme:re,classes:ue,inlineStyles:de}),he={name:"BaseToggleSwitch",extends:J,props:{trueValue:{type:null,default:!0},falseValue:{type:null,default:!1},readonly:{type:Boolean,default:!1},tabindex:{type:Number,default:null},inputId:{type:String,default:null},inputClass:{type:[String,Object],default:null},inputStyle:{type:Object,default:null},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:ge,provide:function(){return{$pcToggleSwitch:this,$parentInstance:this}}},P={name:"ToggleSwitch",extends:he,inheritAttrs:!1,emits:["change","focus","blur"],methods:{getPTOptions:function(o){var e=o==="root"?this.ptmi:this.ptm;return e(o,{context:{checked:this.checked,disabled:this.disabled}})},onChange:function(o){if(!this.disabled&&!this.readonly){var e=this.checked?this.falseValue:this.trueValue;this.writeValue(e,o),this.$emit("change",o)}},onFocus:function(o){this.$emit("focus",o)},onBlur:function(o){var e,w;this.$emit("blur",o),(e=(w=this.formField).onBlur)===null||e===void 0||e.call(w,o)}},computed:{checked:function(){return this.d_value===this.trueValue}}},pe=["data-p-checked","data-p-disabled"],we=["id","checked","tabindex","disabled","readonly","aria-checked","aria-labelledby","aria-label","aria-invalid"];function ve(a,o,e,w,b,l){return p(),h("div",C({class:a.cx("root"),style:a.sx("root")},l.getPTOptions("root"),{"data-p-checked":l.checked,"data-p-disabled":a.disabled}),[d("input",C({id:a.inputId,type:"checkbox",role:"switch",class:[a.cx("input"),a.inputClass],style:a.inputStyle,checked:l.checked,tabindex:a.tabindex,disabled:a.disabled,readonly:a.readonly,"aria-checked":l.checked,"aria-labelledby":a.ariaLabelledby,"aria-label":a.ariaLabel,"aria-invalid":a.invalid||void 0,onFocus:o[0]||(o[0]=function(){return l.onFocus&&l.onFocus.apply(l,arguments)}),onBlur:o[1]||(o[1]=function(){return l.onBlur&&l.onBlur.apply(l,arguments)}),onChange:o[2]||(o[2]=function(){return l.onChange&&l.onChange.apply(l,arguments)})},l.getPTOptions("input")),null,16,we),d("div",C({class:a.cx("slider")},l.getPTOptions("slider")),[d("div",C({class:a.cx("handle")},l.getPTOptions("handle")),[M(a.$slots,"handle",{checked:l.checked})],16)],16)],16,pe)}P.render=ve;const be={class:"p-2 min-h-[56px] flex items-center gap-1 border-b border-[var(--line-color)]"},fe={key:0,class:"!text-lg font-extrabold"},ke={class:"opacity-50 text-sm uppercase"},ye={class:"p-2 pb-[calc(80px+var(--footer-gap))] text-sm"},me={key:0,class:"p-4 text-center"},xe={key:1,class:"p-2"},Ce={key:2,class:"p-2"},Ve={key:3},Se={class:"flex gap-1 py-2"},Be={class:"flex items-center gap-1 px-1 min-h-[48px] border-b border-[var(--line-color)] last:border-b-0"},Oe=q({__name:"optionItems",setup(a){const o=X(),e=Z(),w=Q(),{ingredients:b,sortedIngredients:l,isCloudData:K,isReady:U}=W(),u=S(()=>o.params.category),F=S(()=>E.includes(u.value)),D=S(()=>l.value[u.value]||[]),g=V(!1),k=V(""),m=V(null),y=V("");function T(i){w.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖。${i}`,life:5e3})}async function x(i){g.value=!0;try{return await oe(u.value,i),!0}catch(n){return T(n),!1}finally{g.value=!1}}async function $(){const i=k.value.trim();if(!i)return;const n=b.value[u.value];if(n.some(G=>G.label===i)){w.add({severity:"warn",summary:"重複",detail:`「${i}」已存在`,life:3e3});return}const{sort:t,idx:s}=le(b.value),v={label:i,value:ie(n),active:!0,sort:t,idx:s};await x([...n,v])&&(k.value="")}function R(i){m.value=i.value,y.value=i.label}async function O(i){const n=y.value.trim();if(!n)return;const t=b.value[u.value].map(v=>v.value===i.value?{...v,label:n}:v);await x(t)&&(m.value=null)}async function j(i,n){const t=b.value[u.value].map(s=>s.value===i.value?{...s,active:n}:s);await x(t)}async function A(i){const n=b.value[u.value].map(t=>t.value===i.value?{...t,favorite:!t.favorite}:t);await x(n)}async function _(i){const n=[];E.forEach(t=>{(t===u.value?i:l.value[t]).forEach(v=>n.push(v.idx))}),g.value=!0;try{await ae(n)}catch(t){T(t)}finally{g.value=!1}}return(i,n)=>(p(),h(I,null,[r(c(se),{position:"center"}),d("header",be,[r(c(f),{icon:"pi pi-arrow-left",variant:"text",severity:"secondary",class:"w-[40px] h-[40px] shrink-0",onClick:n[0]||(n[0]=t=>c(e).push("/options"))}),F.value?(p(),h("h1",fe,[ee(B(c(te)[u.value])+" ",1),d("span",ke,B(u.value),1)])):Y("",!0)]),d("main",ye,[c(U)?F.value?c(K)?(p(),h("div",Ve,[n[6]||(n[6]=d("p",{class:"opacity-60 text-xs my-2"}," 按住 ☰ 拖曳排序；選項只能停用不能刪除，停用後不再出現於新增表單，歷史紀錄仍正常顯示。 ",-1)),d("div",Se,[r(c(N),{modelValue:k.value,"onUpdate:modelValue":n[1]||(n[1]=t=>k.value=t),class:"w-full",placeholder:"新增選項名稱",onKeyup:L($,["enter"])},null,8,["modelValue"]),r(c(f),{icon:"pi pi-plus",class:"w-[46px] shrink-0",disabled:g.value||!k.value.trim(),onClick:$},null,8,["disabled"])]),r(c(ce),{"model-value":D.value,"item-key":"value",tag:"ul",handle:".drag-handle",disabled:g.value,class:"border border-[var(--line-color)] rounded-lg shadow-sm overflow-hidden","onUpdate:modelValue":n[4]||(n[4]=t=>_(t))},{item:ne(({element:t})=>[d("li",Be,[n[5]||(n[5]=d("i",{class:"pi pi-bars drag-handle opacity-40 p-2 shrink-0 touch-none"},null,-1)),m.value===t.value?(p(),h(I,{key:0},[r(c(N),{modelValue:y.value,"onUpdate:modelValue":n[2]||(n[2]=s=>y.value=s),class:"w-full",onKeyup:L(s=>O(t),["enter"])},null,8,["modelValue","onKeyup"]),r(c(f),{icon:"pi pi-check",class:"w-[40px] h-[40px] shrink-0",disabled:g.value||!y.value.trim(),onClick:s=>O(t)},null,8,["disabled","onClick"]),r(c(f),{icon:"pi pi-times",severity:"secondary",variant:"outlined",class:"w-[40px] h-[40px] shrink-0",onClick:n[3]||(n[3]=s=>m.value=null)})],64)):(p(),h(I,{key:1},[d("span",{class:z(["w-full",{"opacity-40 line-through":!t.active}])},B(t.label),3),r(c(f),{icon:t.favorite?"pi pi-star-fill":"pi pi-star",variant:"text",class:z(["w-[40px] h-[40px] shrink-0",t.favorite?"[&_.p-button-icon]:text-yellow-500":""]),disabled:g.value,onClick:s=>A(t)},null,8,["icon","class","disabled","onClick"]),r(c(f),{icon:"pi pi-pencil",variant:"text",class:"w-[40px] h-[40px] shrink-0",disabled:g.value,onClick:s=>R(t)},null,8,["disabled","onClick"]),r(c(P),{modelValue:t.active,disabled:g.value,class:"shrink-0","onUpdate:modelValue":s=>j(t,s)},null,8,["modelValue","disabled","onUpdate:modelValue"])],64))])]),_:1},8,["model-value","disabled"])])):(p(),h("div",Ce," 選項尚未匯入雲端，請先回「選項管理」執行匯入。 ")):(p(),h("div",xe," 找不到這個分類，請回「選項管理」重新選擇。 ")):(p(),h("div",me,"載入中..."))])],64))}});export{Oe as default};
