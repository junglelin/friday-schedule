import{l as Ze,s as at,a as xn,b as li,c as ci,d as ui,e as di,_ as Jt}from"./chart.vue_vue_type_script_setup_true_lang-MyBq7BQ4.js";import{d as te,s as ne,a as ye,b as An,c as Ut,e as Bn,f as Dn,i as it,g as ze,h as Pe,j as pi,k as fi,l as hi,m as mi,R as Mt,n as Ue,o as Yt,p as gi,q as bi,r as ve,t as yi,C as vi,u as wi,v as Si,w as Oi,Z as gt,x as Ii,O as ki,y as Ci,z as Ti,A as Ei,B as Ri,D as Fe,U as Xt,E as Li,F as Zt,G as Fi,H as Qt,I as en,J as xi}from"./ingredients-BMVQ0VL6.js";import{d as lt,r as _,o as _t,c as zn,a as O,b,e as pe,t as x,u as $,f as M,g as U,h as P,i as m,B as be,j as B,m as v,k as re,l as Y,F as K,n as oe,p as Ai,q as Pn,s as ee,w as j,T as Un,v as Mn,x as Qe,y as It,C as Ge,z as Bi,A as tn,D as kt,E as Di,G as ct,_ as zi,H as Pi,I as Ui,J as Mi,K as _i,L as Ni,M as Vi,N as nn,S as $i,O as ji,P as Hi,Q as Ki,R as Ct,U as et,V as xe,W as Tt,X as Et,Y as _n,Z as qi,$ as sn,a0 as on,a1 as Wi}from"./index-C27aE4cx.js";const Gi="/friday-schedule/192x192.png",Ji={class:"p-2 sticky top-0 z-20 bg-[var(--bg-color)]"},Yi={class:"grid grid-cols-[3fr_1fr]"},Xi={class:"!text-lg font-extrabold flex items-center"},Zi={class:"w-full text-xs text-gray-400"},Qi={class:"text-right"},eo=lt({__name:"AppHeader",props:{isListView:{type:Boolean},savedDateTime:{}},emits:["toggleView","refresh"],setup(e,{emit:t}){const n=e,s=t,o=_(null),i=()=>{s("toggleView")},r=()=>{s("refresh")};async function a(){o.value=await Ze.getItem("friday-schedule-filedata-savedatetime")}_t(async()=>{a()});const u=zn(()=>n.savedDateTime||o.value);return(l,c)=>(m(),O("header",Ji,[b("div",Yi,[b("h1",Xi,[c[1]||(c[1]=b("img",{src:Gi,class:"w-[50px] mr-2"},null,-1)),b("div",null,[c[0]||(c[0]=pe(" Friday Daily Schedule ")),b("div",Zi," 最新資料時間: "+x(u.value?$(te)(u.value).format("YYYY-MM-DD HH:mm:ss"):"N/A"),1)])]),b("div",Qi,[n.isListView?(m(),M($(ne),{key:0,class:"!bg-[var(--main-color)] mr-2",icon:"pi pi-sync",onClick:r})):U("",!0),P($(ne),{class:"!bg-[var(--main-color)]",icon:n.isListView?"pi pi-chart-bar":"pi pi-list",onClick:i,disabled:n.isListView&&!u.value},null,8,["icon","disabled"])])])]))}});var to=function(t){var n=t.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
...
`)},go={root:"p-iconfield"},bo=be.extend({name:"iconfield",theme:mo,classes:go}),yo={name:"BaseIconField",extends:ye,style:bo,provide:function(){return{$pcIconField:this,$parentInstance:this}}},Hn={name:"IconField",extends:yo,inheritAttrs:!1};function vo(e,t,n,s,o,i){return m(),O("div",v({class:e.cx("root")},e.ptmi("root")),[B(e.$slots,"default")],16)}Hn.render=vo;var wo={root:"p-inputicon"},So=be.extend({name:"inputicon",classes:wo}),Oo={name:"BaseInputIcon",extends:ye,style:So,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},Kn={name:"InputIcon",extends:Oo,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function Io(e,t,n,s,o,i){return m(),O("span",v({class:i.containerClass},e.ptmi("root")),[B(e.$slots,"default")],16)}Kn.render=Io;var ko=function(t){var n=t.dt;return`
...
`)},Na={root:function(t){var n=t.instance;return["p-progressbar p-component",{"p-progressbar-determinate":n.determinate,"p-progressbar-indeterminate":n.indeterminate}]},value:"p-progressbar-value",label:"p-progressbar-label"},Va=be.extend({name:"progressbar",theme:_a,classes:Na}),$a={name:"BaseProgressBar",extends:ye,props:{value:{type:Number,default:null},mode:{type:String,default:"determinate"},showValue:{type:Boolean,default:!0}},style:Va,provide:function(){return{$pcProgressBar:this,$parentInstance:this}}},Is={name:"ProgressBar",extends:$a,inheritAttrs:!1,computed:{progressStyle:function(){return{width:this.value+"%",display:"flex"}},indeterminate:function(){return this.mode==="indeterminate"},determinate:function(){return this.mode==="determinate"}}},ja=["aria-valuenow"];function Ha(e,t,n,s,o,i){return m(),O("div",v({role:"progressbar",class:e.cx("root"),"aria-valuemin":"0","aria-valuenow":e.value,"aria-valuemax":"100"},e.ptmi("root")),[i.determinate?(m(),O("div",v({key:0,class:e.cx("value"),style:i.progressStyle},e.ptm("value")),[e.value!=null&&e.value!==0&&e.showValue?(m(),O("div",v({key:0,class:e.cx("label")},e.ptm("label")),[B(e.$slots,"default",{},function(){return[pe(x(e.value+"%"),1)]})],16)):U("",!0)],16)):i.indeterminate?(m(),O("div",v({key:1,class:e.cx("value")},e.ptm("value")),null,16)):U("",!0)],16,ja)}Is.render=Ha;var Ka=function(t){var n=t.dt;return`
 ...
 */const Es="firebasestorage.googleapis.com",Rs="storageBucket",rl=2*60*1e3,al=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ae{constructor(t,n){this.bucket=t,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const t=encodeURIComponent;return"/b/"+t(this.bucket)+"/o/"+t(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(t,n){let s;try{s=ae.makeFromUrl(t,n)}catch{return new ae(t,"")}if(s.path==="")return s;throw gl(t)}static makeFromUrl(t,n){let s=null;const o="([A-Za-z0-9.\\-_]+)";function i(C){C.path.charAt(C.path.length-1)==="/"&&(C.path_=C.path_.slice(0,-1))}const r="(/(.*))?$",a=new RegExp("^gs://"+o+r,"i"),u={bucket:1,path:3};function l(C){C.path_=decodeURIComponent(C.path)}const c="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),g="(/([^?#]*).*)?$",I=new RegExp(`^https?://${p}/${c}/b/${o}/o${g}`,"i"),f={bucket:1,path:3},w=n===Es?"(?:storage.googleapis.com|storage.cloud.google.com)":n,h="([^?#]*)",T=new RegExp(`^https?://${w}/${o}/${h}`,"i"),E=[{regex:a,indices:u,postModify:i},{regex:I,indices:f,postModify:l},{regex:T,indices:{bucket:1,path:2},postModify:l}];for(let C=0;C<E.length;C++){const D=E[C],V=D.regex.exec(t);if(V){const F=V[D.indices.bucket];let z=V[D.indices.path];z||(z=""),s=new ae(F,z),D.postModify(s);break}}if(s==null)throw ml(t);return s}}class Ol{constructor(t){this.promise_=Promise.reject(t)}getPromise(){return this.promise_}cancel(t=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qt(e,t,n){let s=t;return n==null&&(s=`https://${t}`),`${n}://${s}/v0${e}`}function Fs(e){const t=encodeURIComponent;let n="?";for(const s in e)if(e.hasOwnProperty(s)){const o=t(s)+"="+t(e[s]);n=n+o+"&"}return n=n.slice(0,-1),n}var Ce;(function(e){e[e.NO_ERROR=0]="NO_ERROR",e[e.NETWORK_ERROR=1]="NETWORK_ERROR",e[e.ABORT=2]="ABORT"})(Ce||(Ce={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class Ot{constructor(t,n){this.data=t,this.contentType=n||null}}function Ml(e,t){switch(e){case ge.RAW:return new Ot(xs(t));case ge.BASE64:case ge.BASE64URL:return new Ot(As(e,t));case ge.DATA_URL:return new Ot(Nl(t),Vl(t))}throw jt()}function xs(e){const t=[];for(let n=0;n<e.length;n++){let s=e.charCodeAt(n);if(s<=127)t.push(s);else if(s<=2047)t.push(192|s>>6,128|s&63);else if((s&64512)===55296)if(!(n<e.length-1&&(e.charCodeAt(n+1)&64512)===56320))t.push(239,191,189);else{const i=s,r=e.charCodeAt(++n);s=65536|(i&1023)<<10|r&1023,t.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|s&63)}else(s&64512)===56320?t.push(239,191,189):t.push(224|s>>12,128|s>>6&63,128|s&63)}return new Uint8Array(t)}function _l(e){let t;try{t=decodeURIComponent(e)}catch{throw Ve(ge.DATA_URL,"Malformed data URL.")}return xs(t)}function As(e,t){switch(e){case ge.BASE64:{const o=t.indexOf("-")!==-1,i=t.indexOf("_")!==-1;if(o||i)throw Ve(e,"Invalid character '"+(o?"-":"_")+"' found: is it base64url encoded?");break}case ge.BASE64URL:{const o=t.indexOf("+")!==-1,i=t.indexOf("/")!==-1;if(o||i)throw Ve(e,"Invalid character '"+(o?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=Ul(t)}catch(o){throw o.message.includes("polyfill")?o:Ve(e,"Invalid character found")}const s=new Uint8Array(n.length);for(let o=0;o<n.length;o++)s[o]=n.charCodeAt(o);return s}class Bs{constructor(t){this.base64=!1,this.contentType=null;const n=t.match(/^data:([^,]+)?,/);if(n===null)throw Ve(ge.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const s=n[1]||null;s!=null&&(this.base64=$l(s,";base64"),this.contentType=this.base64?s.substring(0,s.length-7):s),this.rest=t.substring(t.indexOf(",")+1)}}function Nl(e){const t=new Bs(e);return t.base64?As(ge.BASE64,t.rest):_l(t.rest)}function Vl(e){return new Bs(e).contentType}function $l(e,t){return e.length>=t.length?e.substring(e.length-t.length)===t:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ds(e){let t;try{t=JSON.parse(e)}catch{return null}return Tl(t)?t:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jl(e){if(e.length===0)return null;const t=e.lastIndexOf("/");return t===-1?"":e.slice(0,t)}function Hl(e,t){const n=t.split("/").filter(s=>s.length>0).join("/");return e.length===0?n:e+"/"+n}function zs(e){const t=e.lastIndexOf("/",e.length-2);return t===-1?e:e.slice(t+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kl(e,t){return t}class Q{constructor(t,n,s,o){this.server=t,this.local=n||t,this.writable=!!s,this.xform=o||Kl}}let Xe=null;function ql(e){return!Ht(e)||e.length<2?e:zs(e)}function Ps(){if(Xe)return Xe;const e=[];e.push(new Q("bucket")),e.push(new Q("generation")),e.push(new Q("metageneration")),e.push(new Q("name","fullPath",!0));function t(i,r){return ql(r)}const n=new Q("name");n.xform=t,e.push(n);function s(i,r){return r!==void 0?Number(r):r}const o=new Q("size");return o.xform=s,e.push(o),e.push(new Q("timeCreated")),e.push(new Q("updated")),e.push(new Q("md5Hash",null,!0)),e.push(new Q("cacheControl",null,!0)),e.push(new Q("contentDisposition",null,!0)),e.push(new Q("contentEncoding",null,!0)),e.push(new Q("contentLanguage",null,!0)),e.push(new Q("contentType",null,!0)),e.push(new Q("metadata","customMetadata",!0)),Xe=e,Xe}function Wl(e,t){function n(){const s=e.bucket,o=e.fullPath,i=new ae(s,o);return t._makeStorageReference(i)}Object.defineProperty(e,"ref",{get:n})}function Gl(e,t,n){const s={};s.type="file";const o=n.length;for(let i=0;i<o;i++){const r=n[i];s[r.local]=r.xform(s,t[r.server])}return Wl(s,e),s}function Us(e,t,n){const s=Ds(t);return s===null?null:Gl(e,s,n)}function Jl(e,t,n,s){const o=Ds(t);if(o===null||!Ht(o.downloadTokens))return null;const i=o.downloadTokens;if(i.length===0)return null;const r=encodeURIComponent;return i.split(",").map(l=>{const c=e.bucket,p=e.fullPath,g="/b/"+r(c)+"/o/"+r(p),I=qt(g,n,s),f=Fs({alt:"media",token:l});return I+f})[0]}function Yl(e,t){const n={},s=t.length;for(let o=0;o<s;o++){const i=t[o];i.writable&&(n[i.server]=e[i.local])}return JSON.stringify(n)}class Ms{constructor(t,n,s,o){this.url=t,this.method=n,this.handler=s,this.timeout=o,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _s(e){if(!e)throw jt()}function Xl(e,t){function n(s,o){const i=Us(e,o,t);return _s(i!==null),i}return n}function Zl(e,t){function n(s,o){const i=Us(e,o,t);return _s(i!==null),Jl(i,o,e.host,e._protocol)}return n}function Ns(e){function t(n,s){let o;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?o=dl():o=ul():n.getStatus()===402?o=cl(e.bucket):n.getStatus()===403?o=pl(e.path):o=s,o.status=n.getStatus(),o.serverResponse=s.serverResponse,o}return t}function Ql(e){const t=Ns(e);function n(s,o){let i=t(s,o);return s.getStatus()===404&&(i=ll(e.path)),i.serverResponse=o.serverResponse,i}return n}function ec(e,t,n){const s=t.fullServerUrl(),o=qt(s,e.host,e._protocol),i="GET",r=e.maxOperationRetryTime,a=new Ms(o,i,Zl(e,n),r);return a.errorHandler=Ql(t),a}function tc(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function nc(e,t,n){const s=Object.assign({},n);return s.fullPath=e.path,s.size=t.size(),s.contentType||(s.contentType=tc(null,t)),s}function sc(e,t,n,s,o){const i=t.bucketOnlyServerUrl(),r={"X-Goog-Upload-Protocol":"multipart"};function a(){let E="";for(let C=0;C<2;C++)E=E+Math.random().toString().slice(2);return E}const u=a();r["Content-Type"]="multipart/related; boundary="+u;const l=nc(t,s,o),c=Yl(l,n),p="--"+u+`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ee{constructor(t,n){this._service=t,n instanceof ae?this._location=n:this._location=ae.makeFromUrl(n,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,n){return new Ee(t,n)}get root(){const t=new ae(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return zs(this._location.path)}get storage(){return this._service}get parent(){const t=jl(this._location.path);if(t===null)return null;const n=new ae(this._location.bucket,t);return new Ee(this._service,n)}_throwIfRoot(t){if(this._location.path==="")throw Sl(t)}}function rc(e,t,n){e._throwIfRoot("uploadBytes");const s=sc(e.storage,e._location,Ps(),new we(t,!0),n);return e.storage.makeRequestWithTokens(s,Vs).then(o=>({metadata:o,ref:e}))}function ac(e){e._throwIfRoot("getDownloadURL");const t=ec(e.storage,e._location,Ps());return e.storage.makeRequestWithTokens(t,Vs).then(n=>{if(n===null)throw vl();return n})}function lc(e,t){const n=Hl(e._location.path,t),s=new ae(e._location.bucket,n);return new Ee(e.storage,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const js="storage";function fc(e,t,n){return e=ct(e),rc(e,t,n)}function hc(e){return e=ct(e),ac(e)}function mc(e,t){return e=ct(e),dc(e,t)}function gc(e=Di(),t){e=ct(e);const s=zi(e,js).getImmediate({identifier:t}),o=Pi("storage");return o&&bc(s,...o),s}function bc(e,t,n,s={}){pc(e,t,n,s)}function yc(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),o=e.getProvider("app-check-internal");return new Wt(n,s,o,t,$i)}function vc(){Ni(new Vi(js,yc,"PUBLIC").setMultipleInstances(!0)),nn(Rn,Ln,""),nn(Rn,Ln,"esm2017")}vc();const wc={class:"p-2 [&>div]:mb-1 text-sm"},Sc={class:"grid grid-cols-2 gap-1 items-center"},Oc={class:"!text-sm"},Ic={class:"text-right"},kc={key:0,class:"transition duration-300 ease-in-out grid grid-cols-3 [&_div]:p-[2px] [&_div]:m-[2px] [&_div]:bg-[var(--line-color)] [&_div]:rounded-md"},Cc={key:0,class:"col-span-3"},Tc={class:"col-span-3"},Ec={class:"flex"},Rc={class:"w-full"},Lc={class:"[&_span]:m-1"},Fc={key:0,class:"bg-[var(--line-color)] opacity-50 p-2 rounded-md"},xc={class:"flex"},Ac={class:"fixed bottom-4 right-4"},Bc={key:1,class:"w-full bg-black/50 fixed top-0 flex items-end z-30 h-full"},Dc={class:"bg-[var(--bg-color)] w-full p-2 h-full"},zc={class:"h-[calc(100%-60px)] overflow-auto"},Pc={class:"grid grid-cols-2 gap-1"},Uc={class:"card"},Mc={class:"sticky top-0 z-10 p-2 bg-[var(--line-color)] uppercase"},_c=["for"],Nc={key:0,class:"my-2"},Vc={class:"grid grid-cols-2 gap-1 py-4"},$c={class:"grid grid-cols-1 gap-4 bg-gray-700 rounded-lg p-2 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:border-b-1 after:border-dashed after:border-white"},jc={class:"grid grid-cols-5 gap-4 bg-gray-700 rounded-lg p-2"},Hc=["onClick"],Fn=lt({__name:"list",setup(e){const t={0:"晴天",1:"陰天",2:"雨天"},n=[{value:1,label:"家裡"},{value:2,label:"露營"}],s=_(),o=_(),i=_(te().startOf("day").toDate()),r=_(),a=_([]),u=_(""),l=_(1),c=_([]),p=_({latitude:0,longitude:0,display_name:""}),g=_({humidity:"",pressure:"",windSpeed:"",windScale:"",windDir:"",wind360:"",text:"",feelsLike:"",temp:"",obsTime:""}),I={humidity:"",pressure:"",windSpeed:"",windScale:"",windDir:"",wind360:"",text:"",feelsLike:"",temp:"",obsTime:""},f=_(""),w=_(""),h=_(!1),T=ji(),k=_(!0),E=Hi(),C=_(Qt),D=_(null),V=gc(),F=_(!1),z=_([]),X=_(0);function ce(R){return`pi ${{daily:"pi-exclamation-circle",behavior:"pi-exclamation-triangle",hospital:"pi-bolt",medicine:"pi-eraser",vaccine:"pi-ban",food:"pi-apple"}[R]||"pi-question"}`}const G=R=>{const y=R.data();return{id:R.id,remark:y.remark,createDate:y.createDate,updateDate:y.updateDate,forSearchDate:y.forSearchDate,isCurrentDate:y.isCurrentDate,isCurrentTime:y.isCurrentTime,options:{daily:y.options.daily||[],behavior:y.options.behavior||[],hospital:y.options.hospital||[],medicine:y.options.medicine||[],vaccine:y.options.vaccine||[],food:y.options.food||[]},weather:y.weather,locationMode:y.locationMode,location:y.location,status:y.status,createBy:y.createBy,modifyBy:y.modifyBy,timestampCurrentDateTime:y.timestampCurrentDateTime,uploadFiles:y.uploadFiles}},ie=async()=>{try{const R=Ct(et(xe,"friday-daily-schedule"),Tt("forSearchDate",">=",i.value),Et("timestampCurrentDateTime","desc")),y=await _n(R);if(a.value=y.docs.map(G),y.docs.length>0){const[S]=y.docs.slice(-1),A=S.data().timestampCurrentDateTime;r.value=A}}catch(R){console.error("Error fetching documents: ",R)}finally{k.value=!1}},Se=()=>{const R=Ct(et(xe,"friday-daily-schedule"),Tt("forSearchDate",">=",i.value),Et("timestampCurrentDateTime","desc"));qi(R,y=>{a.value=y.docs.map(G)})},Re=R=>{D.value=new FormData,R.forEach(y=>{var S;(S=D.value)==null||S.append("demo[]",y)})},ue=async R=>{try{const y=[];for(const S of R){const A=Date.now(),N=S.name.split(".").pop(),J=`${A}.${N}`,de=mc(V,`pet/dog/friday/${J}`);await fc(de,S),console.log(`文件 ${N} / ${J} 上傳成功！`);const Oe=await hc(de);y.push(Oe),console.log(`File available at ${Oe}`)}return console.log("All files uploaded:",y),y}catch(y){throw console.error("Upload error:",y),y}},he=async()=>{const R={daily:[],behavior:[],hospital:[],medicine:[],vaccine:[],food:[]};c.value&&c.value.length&&c.value.forEach(([A,N])=>{R[A]&&R[A].push(N)});const y=`${te(s.value).format("YYYY-MM-DD")} ${te(o.value).format("HH:mm:ss")}`,S={remark:u.value||"",isCurrentDate:te(s.value).format("YYYY-MM-DD"),isCurrentTime:te(o.value).format("HH:mm:ss"),options:R,status:!0,timestampCurrentDateTime:te(y).valueOf(),locationMode:l.value};if(D.value){const A=Array.from(D.value.entries()).map(([J,de])=>de),N=await ue(A);N.length>0&&(S.uploadFiles=N)}try{if(f.value){const A=sn(xe,"friday-daily-schedule",f.value);try{S.updateDate=te().format("YYYY-MM-DD HH:mm:ss"),S.modifyBy="Cathy",await on(A,S),k.value=!1,h.value=!1,u.value="",c.value=[],f.value=""}catch(N){E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖。${N}`,life:5e3})}}else{r.value=te().toDate(),S.createDate=te().format("YYYY-MM-DD HH:mm:ss"),S.forSearchDate=r.value,S.weather=g.value,S.location=p.value,S.locationMode=l.value,S.createBy="Cathy",console.log(JSON.stringify(S,null,2));return}}catch(A){E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖。${A}`,life:5e3})}};_t(async()=>{ie(),Se()});const Le=zn(()=>a.value.filter(R=>R.status));Ki(h,R=>{R?document.body.style.overflow="hidden":document.body.style.overflow=""});function Hs(R,y){var N;const S=R,A=(N=C.value[S])==null?void 0:N.find(J=>J.value===y);return(A==null?void 0:A.label)||""}const Gt=()=>{h.value=!1,s.value=null,o.value=null,u.value="",g.value={...I},c.value=[],f.value="",w.value="",p.value={longitude:0,latitude:0}},Ks=R=>{T.require({message:"Are you sure you want to proceed?",header:"Update data",icon:"pi pi-exclamation-triangle",rejectProps:{label:"Cancel",severity:"secondary",outlined:!0},acceptProps:{label:"Keep"},accept:async()=>{h.value=!0,s.value=new Date(R.isCurrentDate),o.value=new Date(R.isCurrentDate+" "+R.isCurrentTime),u.value=R.remark,w.value=R.remark,l.value=R.locationMode||1,c.value=[],Object.keys(R.options).forEach(S=>{R.options[S].forEach(A=>{c.value.push([S,A])})});const y={daily:[],behavior:[],hospital:[],medicine:[],vaccine:[],food:[]};c.value.forEach(([S,A])=>{y[S]&&y[S].push(A)}),f.value=(R==null?void 0:R.id)??""},reject:Gt})},qs=R=>{T.require({message:"Are you sure you want to proceed?",header:"Delete data",icon:"pi pi-exclamation-triangle",rejectProps:{label:"Cancel",severity:"secondary",outlined:!0},acceptProps:{severity:"danger",label:"Delete"},accept:async()=>{if(R)try{const y=sn(xe,"friday-daily-schedule",R);await on(y,{status:!1}),console.log(`Document(${R}) successfully deleted!`)}catch(y){E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖。${y}`,life:5e3})}else E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖。Document ID (${R}) is undefined.`,life:5e3})}})},Ws=async()=>{if(k.value=!0,"geolocation"in navigator)try{const R=await new Promise((A,N)=>{navigator.geolocation.getCurrentPosition(A,N,{enableHighAccuracy:!0,timeout:5e3,maximumAge:0})}),y=R.coords.latitude,S=R.coords.longitude;p.value={latitude:y,longitude:S},Gs(y,S)}catch(R){E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖。Error getting location. ${R}`,life:5e3}),k.value=!1}else E.add({severity:"error",summary:"Error",detail:"發生不可預期的錯誤，請先截圖。Geolocation is not supported by this browser.",life:5e3}),k.value=!1};async function Gs(R,y){const S=`https://devapi.qweather.com/v7/weather/now?location=${y},${R}`,A="442073d57d51407e93ea812a3021d8e3",N=`https://nominatim.openstreetmap.org/reverse?format=json&lat=${R}&lon=${y}&zoom=18&addressdetails=1`;try{const[J,de]=await Promise.all([H.get(S,{headers:{"X-QW-Api-Key":A},decompress:!0}),H.get(N)]),Oe=J.data,Xs=de.data,{humidity:Zs,pressure:Qs,windSpeed:ei,windScale:ti,windDir:ni,wind360:si,text:ii,feelsLike:oi,temp:ri,obsTime:ai}=Oe.now;g.value={humidity:Zs.toString(),pressure:Qs.toString(),windSpeed:ei.toString(),windScale:ti.toString(),windDir:ni,wind360:si.toString(),text:ii,feelsLike:oi.toString(),temp:ri.toString(),obsTime:ai},p.value={latitude:y,longitude:R,display_name:Xs.display_name},he()}catch(J){H.isAxiosError(J)?(console.error("Error fetching data:",J.message),E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖2。${J.message}`,life:5e3})):E.add({severity:"error",summary:"Error",detail:`發生不可預期的錯誤，請先截圖3。${J}`,life:5e3})}}const De=_([]),Js=R=>{De.value.includes(R)?De.value=De.value.filter(y=>y!==R):De.value.push(R)};function Ys(R){z.value=R,X.value=0,F.value=!0}return(R,y)=>(m(),O(K,null,[P($(Yn)),P($(ci),{position:"center"}),P($(ui),{blocked:k.value,fullScreen:!0},null,8,["blocked"]),k.value?(m(),M($(di),{key:0,class:"stroke-[var(--main-color)] w-16 h-16 z-[1200] !fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",strokeWidth:"8",fill:"transparent",animationDuration:".5s","aria-label":"Custom ProgressSpinner"})):U("",!0),b("main",null,[b("section",wc,[(m(!0),O(K,null,oe(Le.value,(S,A)=>{var N;return m(),O("div",{key:A,class:"border-[var(--line-color)] border-b pb-1"},[b("div",Sc,[b("h2",Oc,x(S.isCurrentDate)+" "+x(S.isCurrentTime),1),b("div",Ic,[S.uploadFiles?(m(),M($(ne),{key:0,icon:"pi pi-image",class:"w-[80px] h-[40px]",label:"圖檔",variant:"text",size:"small",severity:"info",onClick:J=>Ys(S.uploadFiles)},null,8,["onClick"])):U("",!0),typeof S.weather=="number"?(m(),O(K,{key:1},[pe(x(t[S.weather]),1)],64)):(m(),M($(ne),{key:2,icon:"pi pi-globe",class:ee(["w-[40px] h-[40px] bg-[var(--main-color)]",S.locationMode===1?"[&_span.p-button-icon]:!text-black":S.locationMode===2?"[&_span.p-button-icon]:!text-[var(--main-color)]":"[&_span.p-button-icon]:text-black"]),size:"small",variant:"text",onClick:J=>Js(S.id)},null,8,["class","onClick"]))])]),De.value.includes(S.id)?(m(),O("div",kc,[S.locationMode&&((N=S.location)!=null&&N.longitude)?(m(),O("div",Cc,[pe(" ("+x(S.location.longitude)+","+x(S.location.latitude)+")",1),y[8]||(y[8]=b("br",null,null,-1)),pe(" "+x(S.location.display_name),1)])):U("",!0),b("div",null,"溫度: "+x(S.weather.temp),1),b("div",null,"體感溫度: "+x(S.weather.feelsLike),1),b("div",null,"相對濕度: "+x(S.weather.humidity),1),b("div",null,"天氣狀況: "+x(S.weather.text),1),b("div",null,"風向360角度: "+x(S.weather.wind360),1),b("div",null,"風向: "+x(S.weather.windDir),1),b("div",null,"風力等級: "+x(S.weather.windScale),1),b("div",null,"風速(km/hr): "+x(S.weather.windSpeed),1),b("div",null,"大氣壓強: "+x(S.weather.pressure),1),b("div",Tc,"數據觀測時間: "+x(S.weather.obsTime),1)])):U("",!0),b("div",Ec,[b("div",Rc,[b("div",Lc,[(m(!0),O(K,null,oe(S.options,(J,de)=>(m(),O(K,{key:de},[(m(!0),O(K,null,oe(J,Oe=>(m(),M($(Nn),{key:Oe,icon:ce(de),severity:de==="behavior"?"danger":"info",value:Hs(de,Oe)},null,8,["icon","severity","value"]))),128))],64))),128))]),S.remark?(m(),O("div",Fc," Remark: "+x(S.remark),1)):U("",!0)]),b("div",xc,[P($(ne),{icon:"pi pi-pen-to-square",class:"mx-1 w-[40px] h-[40px]",size:"small",variant:"outlined",onClick:J=>Ks(S)},null,8,["onClick"]),P($(ne),{icon:"pi pi-trash",severity:"danger",class:"w-[40px] h-[40px]",size:"small",variant:"outlined",onClick:J=>qs(S.id)},null,8,["onClick"])])])])}),128))]),b("div",Ac,[P($(ne),{class:"!bg-[var(--main-color)]",icon:"pi pi-plus",onClick:y[0]||(y[0]=S=>{h.value=!0,u.value="",s.value=$(te)().toDate(),o.value=$(te)().toDate()})})])]),h.value?(m(),O("div",Bc,[b("div",Dc,[b("div",zc,[b("div",null,[y[9]||(y[9]=b("label",null,"所在區",-1)),b("div",null,[P($(Jn),{modelValue:l.value,"onUpdate:modelValue":y[1]||(y[1]=S=>l.value=S),options:n,optionLabel:"label",optionValue:"value",class:"w-full"},null,8,["modelValue"])])]),b("div",Pc,[b("div",null,[y[10]||(y[10]=b("label",null,"Date",-1)),P($(en),{modelValue:s.value,"onUpdate:modelValue":y[2]||(y[2]=S=>s.value=S),showIcon:"",fluid:"",iconDisplay:"input"},null,8,["modelValue"])]),b("div",null,[y[11]||(y[11]=b("label",null,"Time",-1)),P($(en),{modelValue:o.value,"onUpdate:modelValue":y[3]||(y[3]=S=>o.value=S),showIcon:"",fluid:"",iconDisplay:"input",timeOnly:""},null,8,["modelValue"])])]),b("div",Uc,[y[12]||(y[12]=b("label",null,"Options",-1)),b("div",null,[(m(!0),O(K,null,oe($(Qt),(S,A)=>(m(),O("div",{key:A},[b("h3",Mc,x(A),1),b("ul",null,[(m(!0),O(K,null,oe(S.filter(N=>N.active),N=>(m(),O("li",{key:N.value,class:"flex py-1"},[P($(xi),{inputId:A+"-"+N.value,modelValue:c.value,"onUpdate:modelValue":y[4]||(y[4]=J=>c.value=J),value:[A,N.value],class:"mr-1"},null,8,["inputId","modelValue","value"]),b("label",{for:A+"-"+N.value,class:"w-full inline-block"},x(N.label),9,_c)]))),128))])]))),128))])]),b("div",null,[y[13]||(y[13]=b("label",null,"Notice",-1)),b("div",null,[P($(Vn),{class:"w-full",modelValue:u.value,"onUpdate:modelValue":y[5]||(y[5]=S=>u.value=S)},null,8,["modelValue"])])]),f.value?U("",!0):(m(),O("div",Nc,[P(ol,{onUploadComplete:Re})]))]),b("div",Vc,[P($(ne),{label:"Cancel",onClick:Gt}),P($(ne),{label:"Save",onClick:y[6]||(y[6]=S=>f.value?he():Ws()),disabled:!c.value.length&&!u.value},null,8,["disabled"])])])])):U("",!0),P($(xn),{visible:F.value,"onUpdate:visible":y[7]||(y[7]=S=>F.value=S),style:{width:"100%"}},{default:j(()=>[b("main",$c,[b("div",{class:"aspect-square bg-center bg-no-repeat bg-cover rounded-lg",style:kt(`background-image: url('${z.value[X.value]}')`)},null,4)]),b("nav",jc,[(m(!0),O(K,null,oe(z.value,(S,A)=>(m(),O("div",{key:A,class:"aspect-square bg-center bg-no-repeat bg-cover rounded-lg cursor-pointer",style:kt(`background-image: url('${S}')`),onClick:N=>X.value=A},null,12,Hc))),128))])]),_:1},8,["visible"])],64))}}),pu=lt({__name:"dashboard",setup(e){const t=I=>{const f=I.data();return{id:I.id,remark:f.remark,createDate:f.createDate,updateDate:f.updateDate,forSearchDate:f.forSearchDate,isCurrentDate:f.isCurrentDate,isCurrentTime:f.isCurrentTime,options:{daily:f.options.daily||[],behavior:f.options.behavior||[],hospital:f.options.hospital||[],medicine:f.options.medicine||[],vaccine:f.options.vaccine||[],food:f.options.food||[]},weather:f.weather,locationMode:f.locationMode,location:f.location,status:f.status,createBy:f.createBy,modifyBy:f.modifyBy,timestampCurrentDateTime:f.timestampCurrentDateTime,uploadFiles:f.uploadFiles}},n=_(!0),s=_([]),o=_(null),i=_(te("2025-01-22").startOf("day").toDate()),r=_(),a=_(i.value),u=_(),l=async()=>{const I=await Ze.getItem("friday-schedule-filedata-savedatetime");I&&(u.value=new Date(I),r.value=u.value)};_t(async()=>{await l()});const c=()=>{n.value=!n.value},p=async()=>{try{const I=Ct(et(xe,"friday-daily-schedule"),Tt("forSearchDate",">=",i.value),Et("timestampCurrentDateTime","desc"));console.log("latestQuery",I);const f=await _n(I);if(s.value=f.docs.map(t).filter(w=>w.status===!0),s.value.length>0){const w=s.value[0],[h,T,k]=w.isCurrentTime.split(":").map(Number),E=te(`${w.isCurrentDate} ${h}:${T}:${k}`);r.value=E.toDate(),u.value=r.value;const C=JSON.parse(JSON.stringify(s.value));console.log(s.value,C),await Ze.setItem("friday-schedule-filedata",C),console.log("資料已儲存到 localForage，key: friday-schedule-filedata"),await Ze.setItem("friday-schedule-filedata-savedatetime",r.value.toISOString()),o.value=r.value.toISOString(),console.log("資料及儲存時間已存入 localForage"),console.log(u.value)}}catch(I){console.error("Error fetching documents: ",I)}},g=()=>{p()};return(I,f)=>(m(),O(K,null,[P(eo,{"is-list-view":n.value,"saved-date-time":o.value,onToggleView:c,onRefresh:g},null,8,["is-list-view","saved-date-time"]),n.value?(m(),M(re(n.value?Fn:Jt),{key:1})):(m(),M(re(n.value?Fn:Jt),{key:0,"selected-min-date":a.value,"selected-max-date":u.value},null,8,["selected-min-date","selected-max-date"]))],64))}});export{pu as default};
