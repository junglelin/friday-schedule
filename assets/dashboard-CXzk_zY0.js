import{s as ie,a as fe,b as $n,c as Be,d as Vn,f as Hn,i as ut,g as Ue,e as Me,h as xt,j as vs,k as Kn,l as ws,R as ht,m as Ne,n as nn,o as Cs,p as Ss,q as ve,r as Is,C as Os,t as ks,u as Ts,v as Es,Z as Ae,w as Rs,O as Ls,x as xs,y as Fs,z as As,A as Bs,B as Fe,U as on,D as Ps,E as zs,F as Ds,G as sn,H as Us,I as rn,J as Ms}from"./index-Bo-bdqPT.js";import{d as mt,c as C,a as b,b as pe,e as U,u as $,o as f,B as he,f as D,g as M,r as B,m,h as Q,t as F,i as q,F as V,j as ne,k as Ns,l as Kt,n as te,w as j,T as qn,p as qt,q as rt,s as dt,C as tt,v as we,x as _s,y as js,z as an,A as H,D as Ft,E as $s,G as gt,_ as Vs,H as Hs,I as Ks,J as qs,K as Ws,L as Gs,M as Js,N as ln,S as Zs,O as Xs,P as Ys,Q as Qs,R as ei,U as ti,V as cn,W as It,X as _e,Y as un,Z as dn,$ as ni,a0 as oi,a1 as pn,a2 as fn,a3 as si}from"./index-CG_qcJ23.js";import{s as Ye,a as Wn,b as ii,c as ri,d as ai,_ as li}from"./chart.vue_vue_type_script_setup_true_lang-CUqpyxlN.js";import{d as de,i as hn}from"./ingredients-3NqNvGhi.js";const ci="/friday-schedule/192x192.png",ui={class:"p-2 sticky top-0 z-20 bg-[var(--bg-color)]"},di={class:"grid grid-cols-[3fr_1fr]"},pi={class:"text-right"},fi=mt({__name:"AppHeader",props:{isListView:{type:Boolean}},emits:["toggleView"],setup(e,{emit:t}){const n=e,o=t,i=()=>{o("toggleView")};return(s,r)=>(f(),C("header",ui,[b("div",di,[r[0]||(r[0]=b("h1",{class:"!text-lg font-extrabold flex items-center"},[b("img",{src:ci,class:"w-[50px] mr-2"}),pe(" Friday Daily Schedule ")],-1)),b("div",pi,[U($(ie),{class:"!bg-[var(--main-color)]",icon:n.isListView?"pi pi-chart-bar":"pi pi-list",onClick:i},null,8,["icon"])])])]))}});var hi=function(t){var n=t.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
