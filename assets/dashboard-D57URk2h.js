import{l as Ze,s as ct,a as Bn,b as pi,c as fi,d as hi,e as mi,_ as Xt}from"./chart.vue_vue_type_script_setup_true_lang-CDRuchJO.js";import{d as X,s as te,a as ye,b as Dn,c as _t,e as zn,f as Pn,i as ot,g as ze,h as Pe,j as gi,k as bi,l as yi,m as vi,R as Nt,n as Ue,o as Zt,p as wi,q as Si,r as ve,t as Oi,C as Ii,u as ki,v as Ci,w as Ti,Z as vt,x as Ei,O as Ri,y as Li,z as Fi,A as xi,B as Ai,D as Fe,U as Qt,E as Bi,F as en,G as Di,H as tn,I as nn,J as zi}from"./ingredients-MuyA6nWa.js";import{d as ut,r as N,u as Un,o as Vt,c as Qe,a as O,b as y,e as pe,t as A,f as $,g as U,h as M,i as P,j as m,B as be,k as D,m as v,l as re,n as Y,F as K,p as oe,q as Pi,s as Mn,v as ne,w as j,T as _n,x as Nn,y as et,z as rt,C as Ge,A as Ui,D as sn,E as Tt,G as Mi,H as dt,_ as _i,I as Ni,J as Vi,K as $i,L as ji,M as Hi,N as Ki,O as on,S as qi,P as Wi,Q as Gi,R as Ji,U as Et,V as tt,W as xe,X as Rt,Y as Lt,Z as Vn,$ as Yi,a0 as rn,a1 as an,a2 as Xi}from"./index-QGXb-IHh.js";const Zi="/friday-schedule/192x192.png",Qi={class:"p-2 sticky top-0 z-20 bg-[var(--bg-color)]"},eo={class:"grid grid-cols-[3fr_1fr]"},to={class:"!text-lg font-extrabold flex items-center"},no={class:"w-full text-xs text-gray-400"},so={class:"text-right"},io=ut({__name:"AppHeader",props:{isListView:{type:Boolean},savedDateTime:{}},emits:["toggleView","refresh"],setup(e,{emit:t}){const n=e,s=t,o=N(null),i=Un(),r=()=>{s("toggleView")},a=()=>{i.require({message:"雲端資料將會同步至LocalForage中，減少雲端讀取流量",header:"確認同步雲端資料？",icon:"pi pi-exclamation-triangle",rejectProps:{label:"取消",severity:"secondary",outlined:!0},acceptProps:{label:"確認",severity:"danger"},accept:()=>{s("refresh")},reject:()=>{}})};async function u(){o.value=await Ze.getItem("friday-schedule-filedata-savedatetime")}Vt(async()=>{u()});const l=Qe(()=>n.savedDateTime||o.value);return(c,p)=>(m(),O("header",Qi,[y("div",eo,[y("h1",to,[p[1]||(p[1]=y("img",{src:Zi,class:"w-[50px] mr-2"},null,-1)),y("div",null,[p[0]||(p[0]=pe(" Friday Daily Schedule ")),y("div",no," 最新資料時間: "+A(l.value?$(X)(l.value).format("YYYY-MM-DD HH:mm:ss"):"N/A"),1)])]),y("div",so,[n.isListView?(m(),U($(te),{key:0,class:"!bg-[var(--main-color)] mr-2",icon:"pi pi-sync",onClick:a})):M("",!0),P($(te),{class:"!bg-[var(--main-color)]",icon:n.isListView?"pi pi-chart-bar":"pi pi-list",onClick:r,disabled:n.isListView&&!l.value},null,8,["icon","disabled"])])])]))}});var oo=function(t){var n=t.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
